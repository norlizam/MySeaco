...
public class GeoLocation {
    ...
    public class GetAddressTask extends AsyncTask<android.location.Location, Void, String> {
        ...
        protected void onPostExecute (String address) {
            ...
            Log.d("GeoLocation Street", "GeoLocation Street["+mStreet+"]");
            Log.d("GeoLocation No.", "GeoLocation No.["+mHouseNumber+"]");
            Log.d("GeoLocation Postalcode", "GeoLocation Postalcode["+mPostalCode+"]");
            Log.d("GeoLocation Locality", "GeoLocation Locality"+mCity+"]");
            Log.d("GeoLocation Lat/Lng", "GeoLocation Lat/Lng["+ mLongtitude + "]");
        }
    }
}
