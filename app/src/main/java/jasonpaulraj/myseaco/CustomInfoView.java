...
class CustomInfoView extends Config implements GoogleMap.InfoWindowAdapter {
    ...
    CustomInfoView(LayoutInflater inflater, String a) {
    ...
    public View getInfoContents(Marker marker) {
        ...
        Button btnEdit = (Button) popup.findViewById(R.id.btnEdit);
